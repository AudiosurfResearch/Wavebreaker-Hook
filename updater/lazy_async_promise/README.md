> [!NOTE]  
> This code is a slightly modified version of the [original](https://github.com/ChrisRega/lazy_async_promise) crate. Pretty much all I did was replace ``BoxedSendError`` with ``anyhow::Error``.
