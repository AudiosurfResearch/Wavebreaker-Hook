...
use windows::{
    Win32::{
        Networking::WinInet::{
            INTERNET_FLAG_RELOAD, INTERNET_FLAG_SECURE, INTERNET_OPTION_URL, InternetQueryOptionA,
        },
...
#[crochet::hook(
    library = "BASS_PreCalcSong.dll",
    symbol = "?CallChannel@Aco_BASS_PreCalcSong@@UAEXXZ"
)]
...
#[crochet::hook(
    library = "FolderExploder.dll",
    symbol = "?CallChannel@FolderExploder@@UAEXXZ"
)]
